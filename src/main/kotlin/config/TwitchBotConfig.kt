...
object TwitchBotConfig {
    ...
    val ttsMonsterToken = File("data\\tokens\\ttsMonsterToken.txt").readText()
    ...
    val isFirstLeaderboardEnabled: Boolean = properties.getProperty("is_first_leaderboard_enabled_by_default").toBoolean()
    val isCoinFlipEnabled: Boolean = properties.getProperty("is_coin_flip_enabled_by_default").toBoolean()
